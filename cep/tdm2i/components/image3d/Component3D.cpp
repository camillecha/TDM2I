...
// --------------- Constructor -------------------
Component3D::Component3D(const QString & file) throw(AbortException)
:
ImageComponent(file)
{
    // Set the properties with their default values
    addProperty(new Property(tr("objet3d"), "null", tr("Coordonnee en 3D de l'objet a afficher sur l'image IRM"), ""));
