...
#ifndef EXTCOMPONENT_H
#define EXTCOMPONENT_H

#include <QObject>

#include<ComponentExtension.h>

class ExtComponent : public camitk::ComponentExtension {
    Q_OBJECT
    Q_INTERFACES(camitk::ComponentExtension);
    Q_PLUGIN_METADATA(IID "fr.imag.camitk.wizardgenerated.component.ExtComponent")

public:
    /// Constructor
    ExtComponent() : ComponentExtension() {};
